...
window.onorientationchange = function(){window.location.reload();document.getElementById("mainContent").style.display = "none";}
...
function openMoreInfo(){
    ...
    if(x.top == '100%' || x.top == ''){
    	x.top = 0; y.transform = 'rotate(45deg)'; y.width = '17px'; y.height = '17px';      
